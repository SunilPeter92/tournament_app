               ...
               child: InkWell(
                 onTap: () async {
                   ...
                   if (_formKey.currentState.validate()) {
                     // pr.show();
                     API.Edit_Profile(context , usernameController.text ,  emailController.text , mobileController.text , dobController.text , radioButtonItem.toString() , userid  );
                   }
                 },
                 child: Container(
                   height: 45,
               ...
               child: InkWell(
                 onTap: () async {
                   ...
                   if (_resetformkey.currentState.validate()) {
                     ...
                     API.Reset_Password(context ,  oldpassController.text , newpassController.text , userid.toString()  );
                   }
                 },
                 child: Container(
                   height: 45,
